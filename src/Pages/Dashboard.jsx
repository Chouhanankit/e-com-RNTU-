  ...
  return (
    <>
      <div className="min-h-screen bg-gray-50/50">
        <aside className="bg-gradient-to-br from-gray-800 to-gray-900 -translate-x-80 absolute top-20 inset-0 my-4 ml-4 h-[calc(100vh-32px)] w-72 rounded-xl transition-transform duration-300 xl:translate-x-0">
          <div className="m-4">
          ...
          <nav className="block w-full max-w-full bg-transparent text-white shadow-none rounded-xl transition-all px-0 py-1">
            <div className="flex flex-col-reverse justify-between gap-6 md:flex-row md:items-center">
              <div className="flex items-center">
                <div className="flex  mr-auto md:mr-4 float-end w-full">
                  <Link className="bg-blue-500 flex items-center justify-center mr-2 w-[200px] p-2 rounded-[5px]" to={"/productfoam"}>
                    Create Item
                  </Link>
                  <Link className="bg-blue-500 flex items-center justify-center mr-2 w-[200px] p-2 rounded-[5px]" to={"/AllUsers"}>
                    View All Users
                  </Link>
                </div>
